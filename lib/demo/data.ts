...
export const DEMO_ALL_ROUNDS: Round[] = [
  ...DEMO_PLAYER_ROUNDS,
  {
    ...
    courseName: 'Winged Foot West', courseRating: 73.8, slopeRating: 142,
    grossScore: 79, netScore: 71, differentialScore: 3.3,
    attestations: [{ attestorUid: 'demo-p3', attestorName: 'Jake Torres', attestedAt: ts('2026-04-10'), method: 'qr_scan' }],
    isValid: true, submittedAt: ts('2026-04-10'), notes: '',
  },
  {
    id: 'demo-r11', uid: 'demo-p2', seasonId: 'demo-season', month: '2026-04',
    courseName: 'Pebble Beach', courseRating: 72.2, slopeRating: 138,
    grossScore: 94, netScore: 76, differentialScore: 14.2,
    attestations: [{ attestorUid: 'demo-p4', attestorName: 'Brian Lee', attestedAt: ts('2026-04-14'), method: 'qr_scan' }],
    isValid: true, submittedAt: ts('2026-04-14'), notes: '',
  },
  {
    id: 'demo-r12', uid: 'demo-p3', seasonId: 'demo-season', month: '2026-04',
    courseName: 'Augusta National', courseRating: 72.0, slopeRating: 137,
    grossScore: 74, netScore: 69, differentialScore: 1.3,
    attestations: [{ attestorUid: 'demo-p1', attestorName: 'Mike Sullivan', attestedAt: ts('2026-04-18'), method: 'qr_scan' }],
    isValid: true, submittedAt: ts('2026-04-18'), notes: '',
  },
  {
    id: 'demo-r13', uid: 'demo-p4', seasonId: 'demo-season', month: '2026-04',
    courseName: 'TPC Sawgrass', courseRating: 72.5, slopeRating: 135,
    grossScore: 99, netScore: 77, differentialScore: 17.6,
    attestations: [{ attestorUid: 'demo-p2', attestorName: 'Chris Park', attestedAt: ts('2026-04-20'), method: 'qr_scan' }],
    isValid: true, submittedAt: ts('2026-04-20'), notes: '',
  },
  {
    id: 'demo-r14', uid: 'demo-p5', seasonId: 'demo-season', month: '2026-04',
    courseName: 'Merion Golf Club', courseRating: 71.8, slopeRating: 140,
    grossScore: 83, netScore: 71, differentialScore: 7.2,
    attestations: [{ attestorUid: 'demo-p6', attestorName: 'Sam Patel', attestedAt: ts('2026-04-22'), method: 'qr_scan' }],
    isValid: true, submittedAt: ts('2026-04-22'), notes: '',
  },
  {
    id: 'demo-r15', uid: 'demo-p6', seasonId: 'demo-season', month: '2026-04',
    courseName: 'Shinnecock Hills', courseRating: 73.2, slopeRating: 141,
    grossScore: 92, netScore: 76, differentialScore: 11.9,
    attestations: [{ attestorUid: 'demo-p5', attestorName: 'Tyler Knox', attestedAt: ts('2026-04-25'), method: 'qr_scan' }],
    isValid: true, submittedAt: ts('2026-04-25'), notes: '',
  },
  {
    id: 'demo-r16', uid: 'demo-p7', seasonId: 'demo-season', month: '2026-04',
    courseName: 'Oakmont CC', courseRating: 73.5, slopeRating: 145,
    grossScore: 81, netScore: 71, differentialScore: 4.6,
    attestations: [{ attestorUid: 'demo-p1', attestorName: 'Mike Sullivan', attestedAt: ts('2026-04-28'), method: 'qr_scan' }],
    isValid: true, submittedAt: ts('2026-04-28'), notes: '',
  },
]
